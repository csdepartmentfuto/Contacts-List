...
class FriendsActivity : AppCompatActivity() {
    ...
    private val friendsAdapter = ContactAdapter()
    ...
    private fun setUpContact() {
        ...
        val friendsRecyclerView = binding.contactsRv

        friendsRecyclerView.layoutManager = gridLayoutManger
        ...
        saveButton.setOnClickListener {
            ...
            friendsAdapter.setUpData(contacts)
            alertDialog.dismiss()
        }
    }
}