...
class WorkActivity : AppCompatActivity() {
    ...
    private val workAdapter = ContactAdapter()
    ...
    private fun setUpContact() {
        ...
        val workRecyclerView = binding.contactsRv

        workRecyclerView.layoutManager = gridLayoutManger
        ...
        saveButton.setOnClickListener {
            ...
            workAdapter.setUpData(contacts)
            alertDialog.dismiss()
        }
    }
}