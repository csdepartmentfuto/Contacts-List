...
class SchoolActivity : AppCompatActivity() {
    ...
    private val schoolAdapter = ContactAdapter()
    ...
    private fun setUpContact() {
        ...
        val schoolRecyclerView = binding.contactsRv

        schoolRecyclerView.layoutManager = gridLayoutManger
        ...
        saveButton.setOnClickListener {
            ...
            schoolAdapter.setUpData(contacts)
            alertDialog.dismiss()
        }
    }
}